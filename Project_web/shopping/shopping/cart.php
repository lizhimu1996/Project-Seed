          ...
          <table class="table table-bordered table-striped text-center">
            <thead>
              <tr>
                ...
                <th>Total Price</th>
                <th>
                  <a href="action.php?clear=all" class="badge-dark badge p-1" onclick="return confirm('remove cart?');"></i>&nbsp;&nbsp;Remove</a>
                </th>
              </tr>
            </thead>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="action.php?remove=<?= $row['id'] ?>" icon="&#12816" onclick="return confirm('Remove cart?');"><i class="fas fa-remove-alt"></i></a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                <a href="checkout.php" class="btn btn-info <?= ($grand_total > 1) ? '' : 'disabled'; ?>"></i>&nbsp;&nbsp;Checkout</a>
                </td>
              </tr>
            </tbody>
          </table>
